...
from doc_orphan_cleanup.utils.logging import logger, setup_logging
...
if __name__ == "__main__":
    try:
        ...
        logger.info("DRS orphaned documents cleanup job starting.")
        job(config)
        logger.info("DRS orphaned documents cleanup job completed.")
