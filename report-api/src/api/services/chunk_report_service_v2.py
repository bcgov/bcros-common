...
"""Service for generating large reports using chunk approach."""  # pylint: disable=duplicate-code
import asyncio
import io
import os
import tempfile
...
class ChunkReportService:  # pylint:disable=too-few-public-methods
    ...
    TEMPLATE_FOLDER_PATH = TEMPLATE_FOLDER_PATH_V2
    ...
    def _build_chunk_html(
        ...
        template = ChunkReportService._TEMPLATE_ENV.get_template(
            f'{TEMPLATE_FOLDER_PATH_V2}/{template_name}.html'
        )
